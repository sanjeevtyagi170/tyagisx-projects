...
default_args = {
    'owner': 'Sanjeev Tyagi',
    'start_date': days_ago(2),# start the DAG today
...
extract_data_from_tsv= BashOperator(
    ...
    bash_command='cut -f 5,6,7 /home/project/airflow/dags/finalassignment/staging/tollplaza-data.tsv \
...
extract_data_from_fixed_width = BashOperator(
    ...
    bash_command='cut -c 58-62,63-71 /home/project/airflow/dags/finalassignment/staging/payment-data.txt \
...
delete_files = BashOperator(
    ...
    /home/project/airflow/dags/finalassignment/staging/transformed_data.csv \
    /home/project/airflow/dags/finalassignment/staging/._vehicle-data.csv \
    /home/project/airflow/dags/finalassignment/staging/._tollplaza-data.tsv',
    dag=dag
)
