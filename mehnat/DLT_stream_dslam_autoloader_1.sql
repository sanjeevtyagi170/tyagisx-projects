...
-- CREATE OR REPLACE TABLE kpn_test.bronze.dslam_raw
-- AS SELECT * FROM JSON.`/FileStore/tables/`;
...
CREATE OR REFRESH STREAMING LIVE TABLE DSLAM_RAW
COMMENT "DSLAM data"
AS SELECT * FROM cloud_files("/FileStore/tables/", "json");
